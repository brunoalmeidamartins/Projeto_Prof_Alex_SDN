...
#####Medias
media_h1_sem_QoS=round(media(h1_sem_QoS),APROX)
media_h1_com_QoS=round(media(h1_com_QoS),APROX)
...
ic_h1_sem_qos=ic(h1_sem_QoS,tab)
ic_h1_com_qos=ic(h1_com_QoS,tab)
...
print('Desvio Padrao: '+str(round(desvioPadrao(h1_sem_QoS),APROX)))
print('Variancia: '+str(round(variancia(h1_sem_QoS),APROX)))
print('IC H1_Sem_QoS: '+str(ic_h1_sem_qos))

#h1_com_QoS
print('\n\nMedia H1_Com_QoS: '+str(media_h1_com_QoS))
print('Desvio Padrao: '+str(round(desvioPadrao(h1_com_QoS),APROX)))
print('Variancia: '+str(round(variancia(h1_com_QoS),APROX)))
...
#if teste == 'SemIperf':
param1=[media_h1_sem_QoS, media_h1_com_QoS]
param2=[(ic_h1_sem_qos[1]-ic_h1_sem_qos[0])/2,(ic_h1_com_qos[1]-ic_h1_com_qos[0])/2]
nome = 'Cenario '+cenario+' sem carga de trabalho'
desenha(param1,param2, 600,nome,'SemIperf')
#elif teste == '1Iperf':
